...
Consulte `docs/ARCHITECTURE.md`, `docs/PRODUCT_RULES.md`, `docs/DATABASE_RULES.md`, **`docs/DEPLOY.md`** (GitHub + Vercel) e **`docs/OPEN_ROUTE_ETA_SMS.md`** (Open route + ETA + SMS — planejado).
