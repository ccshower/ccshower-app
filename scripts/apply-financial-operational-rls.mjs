/**
 * Aplica RLS operacional da equipe financeira.
 * Uso: node scripts/apply-financial-operational-rls.mjs
 */
...
const SQL = readFileSync(
  resolve(process.cwd(), "supabase/migrations/20250609100000_financial_operational_rls.sql"),
  "utf8",
);
...
try {
  ...
  console.log("RLS financeiro operacional aplicado com sucesso.");
} finally {
  await client.end();
}
