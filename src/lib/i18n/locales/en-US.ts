  ...
  os: {
    ...
    workspace: {
      ...
      project: {
        ...
        fichaImportPending: "Waiting for extraction",
        fichaImportProcessing: "Extracting…",
        fichaImportCompleted: "Imported",
        fichaImportFailed: "Extraction failed",
        fichaImportSkipped: "Extraction not configured",
        fichaImportWaiting:
          "PDF received — waiting for N8N to extract hardware items…",
        fichaImportFailedDetail: "{file}: {error}",
        fichaImportUnknownError: "Unknown extraction error",
