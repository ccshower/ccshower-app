  ...
  os: {
    ...
    workspace: {
      ...
      project: {
        ...
        fichaImportPending: "Aguardando extração",
        fichaImportProcessing: "Extraindo…",
        fichaImportCompleted: "Importada",
        fichaImportFailed: "Falha na extração",
        fichaImportSkipped: "Extração não configurada",
        fichaImportWaiting:
          "PDF recebido — aguardando N8N extrair os itens de hardware…",
        fichaImportFailedDetail: "{file}: {error}",
        fichaImportUnknownError: "Erro desconhecido na extração",
