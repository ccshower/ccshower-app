...
export const ptBR = {
  ...
  os: {
    ...
    workspace: {
      ...
      openRouteLoading: "Abrindo rota…",
      openRouteGpsDenied: "Localização indisponível. Abrindo rota sem ETA.",
      openRoutePhoneMissing: "Telefone do cliente ausente. Rota aberta sem SMS.",
      openRouteUnavailable: "Rota indisponível.",
      openRouteError: "Não foi possível abrir a rota. Tente novamente.",
      ...
      project: {
        ...
        cncPerAmbienteHint: "Um desenho por ambiente — envie pelo card de cada banheiro.",
        cncUploadForAmbiente: "Enviar desenho deste ambiente",
        cncNoneForAmbiente: "Nenhum desenho neste ambiente",
        cncFileCount: "{count} arquivo(s)",
        cncGeneral: "Desenhos gerais (sem ambiente vinculado)",
        cncUploaded: "{count} arquivo(s) enviado(s)",
        cncUploading: "Enviando…",
        fichaTecnicaTitle: "Ficha técnica",
        fichaTecnicaSubtitle:
          "Hardware extraído automaticamente do PDF de projeto (ex.: SHOWER FITTINGS).",
        fichaTecnicaCount: "{count} itens",
        fichaTecnicaEmpty:
          "Envie um PDF de projeto para gerar a ficha técnica automaticamente.",
        fichaAmbienteGeral: "Geral",
        fichaColQty: "Qtd",
        fichaColSku: "SKU",
        fichaColGlass: "Vidro",
        fichaColFinish: "Acabamento",
        ...
        fichaImportWaiting:
          "Aguarde — atualizando a ficha técnica a partir do PDF…",
        fichaImportFailedDetail:
          "Não foi possível ler os itens de {file}. {error}",
  ...
  event: {
    type: {
      ...
      cnc_ficha_importada: "Ficha técnica importada do PDF",
